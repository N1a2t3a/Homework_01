...
# =========================================================
class Record():
    def __init__(self, name: Name, phones: Phone = None, email: Email = None, birthday: Birthday = None,
    ...
    def __str__(self):
        return "{}{}{}{}{}".format(
            ...
            'Email: ' + str(self.email.value) + "\n" if self.email != "None" else "Email: No email\n",
            'Address: ' + str(self.address) + "\n" if self.address != "None" else 'Address: No address\n',
            'Birthday: ' + str(
                self.birthday.value) + "\n" if self.birthday != "None" else "Birthday: No birthday date\n")
